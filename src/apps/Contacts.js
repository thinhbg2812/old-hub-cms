              ...
              <div className="contact-list-header">
                ...
                <Dropdown align="end">
                  ...
                  <Dropdown.Menu>
                    ...
                    <Dropdown.Item href="">
                      <i className="ri-list-settings-line"></i> Contact Settings
                    </Dropdown.Item>
                  </Dropdown.Menu>
                </Dropdown>
              </div>
            ...
            <PerfectScrollbar className="contact-content">
              ...
              <div className="d-sm-flex p-2 p-sm-4 p-md-2 p-xl-4">
                ...
                <div className="flex-fill">
                  ...
                  <div className="d-flex">
                    ...
                    <Button variant="" className="btn-icon btn-gray ms-1">
                      <i className="ri-star-line"></i>
                    </Button>
                    <Button variant="" className="btn-icon btn-gray ms-1">
              ...
              <Row>
                ...
                <Col>
                  ...
                  of a Major Soft Drink Manufacturer. When I give out candies, I
                  give people the flavour I don't like.
                </Col>
              </Row>
