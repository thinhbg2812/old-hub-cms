        ...
        <PerfectScrollbar className="email-sidebar p-4">
          ...
          <Nav className="nav-sidebar">
            <Nav.Link href="" className="active">
              <i className="ri-inbox-fill"></i> Inbox
            </Nav.Link>
            <Nav.Link href="">
          ...
          <Nav className="nav-sidebar">
            ...
            <Nav.Link href="">
              <i className="ri-folder-info-line"></i> Updates
            </Nav.Link>
            <Nav.Link href="">
              <i className="ri-trophy-line"></i> Promotions
            </Nav.Link>
            <Nav.Link href="">
              <i className="ri-discuss-line"></i> Forums
            </Nav.Link>
            <Nav.Link href="">
              <i className="ri-exchange-dollar-line"></i> Finance
            </Nav.Link>
            <Nav.Link href="">
              <i className="ri-bug-line"></i> Bug Reports
            </Nav.Link>
          </Nav>
        </PerfectScrollbar>
            ...
            <Nav as="nav">
              ...
              {[
                ...
                <OverlayTrigger
                  key={index}
                  placement="bottom"
                  overlay={<Tooltip>{menu.title}</Tooltip>}
                >
                  <Nav.Link className={menu.addonClass && menu.addonClass}>
          ...
          <div className="email-content-body p-4">
            <div className="email-msg-item">
              <div className="d-flex align-items-center fs-sm mb-4">
                ...
                <span className="fs-xs text-secondary d-none">
                  11:15am (3 hours ago)
                </span>
                <Nav className="nav-icon ms-3">
                  <Nav.Link href="" className="d-none d-sm-block">
                    ...
                    <Card className="card-attachment">
                      <Card.Body>
                        ...
                        <div className="card-content">
                          <h6>
                            <Link to="#">MarketingAssets.zip</Link>
                          </h6>
                          <span>835kb</span>
                        </div>
                      </Card.Body>
                  ...
                  <Col>
                    <Card className="card-attachment">
                      <Card.Body>
                        ...
                        <div className="card-content">
                          <h6>
                            <Link href="#">Marketing_Report.xls</Link>
                          </h6>
                          <span>922kb</span>
                        </div>
                      </Card.Body>
            ...
            <div className="compose-wrapper">
              <Form.Control
                as="textarea"
                rows="4"
                placeholder="Type here to Reply or Forward"
              ></Form.Control>
          ...
          <div className="compose-content">
            ...
            <div className="compose-body">
              <Form.Group>
                <Form.Control
                  type="text"
                  placeholder="Enter receipient's email address"
                />
              </Form.Group>
              <Form.Group>
            ...
            <div className="compose-footer">
              <Button variant="primary" type="submit" className="btn-icontext">
                Send
              </Button>
              <Button variant="" className="btn-white btn-icon">
