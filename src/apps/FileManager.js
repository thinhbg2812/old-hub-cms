    ...
    <React.Fragment>
      ...
      >
        <PerfectScrollbar className="file-sidebar">
          ...
          <Nav className="nav-sidebar mb-4">
            <Nav.Link href="" className="active">
              <i className="ri-file-text-fill"></i> All Files
            </Nav.Link>
            <Nav.Link href="">
              <i className="ri-macbook-line"></i> My Devices
            </Nav.Link>
            <Nav.Link href="">
              <i className="ri-folder-history-line"></i> Recents
            </Nav.Link>
            <Nav.Link href="">
              <i className="ri-star-line"></i> Important
            </Nav.Link>
            <Nav.Link href="">
              <i className="ri-delete-bin-line"></i> Deleted Files
            </Nav.Link>
          </Nav>
          ...
          <Nav className="nav-sidebar mb-4">
            ...
            <Nav.Link href="">
              <i className="ri-live-line"></i> Videos
            </Nav.Link>
            <Nav.Link href="">
              <i className="ri-music-2-line"></i> Audio
            </Nav.Link>
            <Nav.Link href="">
              <i className="ri-file-zip-line"></i> Zip Files
            </Nav.Link>
          </Nav>
        ...
        <PerfectScrollbar className="file-content p-3 p-lg-4">
          ...
          <label className="d-block fs-sm text-secondary mb-3">
                  ...
                  <Dropdown align="end" className="dropdown-file">
                    ...
                    <Dropdown.Menu>
                      ...
                      <Dropdown.Item href="#" className="important">
                        <i className="ri-star-line"></i> Mark as Important
                      </Dropdown.Item>
