      ...
      <div className="main main-app app-music p-3 p-lg-4 p-xxl-5">
          ...
          <Col xl>
            <div className="music-headline mb-4 mb-xxl-5">
              ...
              <div>
                ...
                <Link to="" className="btn btn-icon btn-outline-white">
                  ...
                  <Col key={index}>
                    <div className="music-item">
                      <Link to="" className="music-thumb mb-3">
                        <img src={album.img} alt="" className="img-fluid" />
                      </Link>
                ...
                <Card className="card-album">
                  <Card.Body className="p-3">
                    <Row className="g-1 mb-2">
                      ...
                      <Col xs="3" md="6">
                        <img src={img32} className="img-fluid" alt="" />
                      </Col>
                      <Col xs="3" md="6">
                    ...
                    <h6 className="music-title">
                      <Link to="">The Greatest Hits</Link>
                    </h6>
                    <span className="music-text-sm">
                      56 Songs - 2 hours 3 minutes
                    </span>
                  </Card.Body>
                </Card>
              </Col>
                  ...
                  <tbody>
                    {[
                      ...
                      <tr key={index}>
                        ...
                        <td className="w-15">
                          <span className="time">{music.time}</span>
                        </td>
                        <td className="w-5">
              ...
              <Row className="g-2 g-lg-3">
                {[
                  ...
                  <Col key={index}>
                    <div className="music-item">
                      <Link to="" className="music-thumb mb-3">
                        <img src={artist.img} alt="" className="img-fluid" />
                      </Link>
                      <h6 className="music-title">
        ...
        <div className="music-player mt-4 mt-xxl-5">
          <div className="media-music">
            ...
            <div className="media-body">
              <h6>
                <Link to="">One Thing Remains - Live</Link>
              </h6>
          ...
          <div className="flex-fill ms-2 ms-sm-3 mg-lg-4">
            ...
            <div className="d-flex align-items-center">
              <Nav className="nav-player flex-fill">
                ...
                <Nav.Link href="" className="lg">
                  <i className="ri-skip-back-line"></i>
                </Nav.Link>
                <Nav.Link href="" className="lg play">
                  <div>
