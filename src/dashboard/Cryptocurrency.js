        ...
        <Row className="g-3">
            ...
            <Card className="card-one">
              ...
              <Card.Body>
                <ReactApexChart
                  ...
                  type="area"
                  height={290}
                  className="apex-chart-nine mb-4"
                />
                ...
                <Row className="row-cols-auto gy-3 gx-5">
                  {[
                    ...
                    <Col key={index}>
                      <label className="fs-xs mb-1 text-secondary">
                        {item.label}
                      </label>
                      <h4 className="ff-numerals text-dark mb-0">
                        {item.value}
                      </h4>
                    </Col>
                  ))}
          ...
          <Col sm="6" xl="4">
            <Card className="card-one">
              ...
              <Card.Body>
                <Card.Title as="label" className="fw-medium fs-sm mb-1">
                  Available Balance
                </Card.Title>
                <h3 className="card-value mb-1">
                  26.00453100 <span className="text-secondary">BTC</span>
                </h3>
                <div className="d-flex gap-2 ff-numerals fs-sm">
                  <div>
                    <span className="text-primary">USD</span> $103,342.50
                  </div>
                  <div>
                    <span className="text-success">EUR</span> $91,105.00
                  </div>
                </div>

                <div className="d-flex gap-2 mt-4 mb-4">
                  <Button variant="white" as="a" href="" className="flex-fill">
                    Send
                  </Button>
                  <Button
                    variant="primary"
                ...
                <div className="d-flex align-items-center justify-content-between fs-xs mb-1">
                  <label className="mg-b-0 fw-medium text-secondary">
                    Recent Transactions
                  </label>
              ...
              <Card.Body>
                <div className="position-absolute p-1">
                  ...
                  <h3 className="card-value">
                    <span className="text-secondary">$</span>7,428.68
                  </h3>
                </div>
                    ...
                    >
                      ...
                      <div className="ms-auto text-end">
                        <h6 className="ff-numerals mb-0">
                          {item.value} {item.icon.toUpperCase()}
                        </h6>
                ...
                {[
                  ...
                  <div className="news-item" key={index}>
                    ...
                    <div className="news-body">
                      <label className="d-block mb-1 fs-sm text-primary">
                        {item.author}
                      </label>
                  ...
                  <React.Fragment key={index}>
                    ...
                    <ListGroup as="ul" className="list-group-one">
                      {item.transactions.map((trans, ind) => (
                        ...
                        >
                          <div
                            className={`avatar border border-2 border-${trans.color} text-${trans.color}`}
                          >
