          ...
          <Col xl="6">
            <Card className="card-one card-ticket-earnings">
              <Card.Body className="d-flex flex-column p-4">
                <h1 className="card-value mb-3 fs-40 ls--2">
                  <span>$</span>14,869.95
                </h1>
                ...
                <p className="mb-5">
                  <Button as="a" variant="primary" className="fs-sm">
                    View Statements
                  </Button>
                </p>
                    ...
                    <div className="d-flex justify-content-end">
                      <div className="w-45">
                        ...
                        <p className="text-secondary fs-sm mb-0">
                          Cura bitur ullam corper ultri cies nisi nam eget dui
                          etiam rhoncus.
                        </p>
                      </div>
                    </div>
                  ...
                  <Card.Body className="p-4">
                    <div className="d-flex flex-column align-items-center">
                      ...
                      <p className="text-secondary text-center fs-sm mb-0">
                        Ullam corper ultricies cura bitur nisi nam eget dui
                        etia.
                      </p>
                    </div>
                  </Card.Body>
                    ...
                    <Table className="table-agent mb-0" responsive>
                      ...
                      <tbody>
                        {[
                          ...
                          <tr key={index}>
                            <td>
                              <span className="ff-numerals">{item.id}</span>
                            </td>
                            <td>
                            ...
                            <td>
                              <span className="ff-numerals">{item.quota}</span>
                            </td>
                            <td>
              ...
              <Col md="6" xl="12">
                <Card className="card-one">
                  ...
                  <Card.Body>
                    ...
                    <p className="fs-sm">
                      Measures the quality or your event's performance.
                    </p>
            ...
            <Card className="card-one">
              ...
              <Card.Body className="p-3">
                ...
                <p className="fs-sm mb-3">
                  Measures the overall reviews and ratings of your event's
                  performance.
                </p>
                ...
                <ul className="events-reviews">
                  {[
                    ...
                    <li key={index}>
                      ...
                      <p>
                        {item.text}...<Link to="">Read more</Link>
                      </p>
                    </li>
                  ))}
                </ul>
