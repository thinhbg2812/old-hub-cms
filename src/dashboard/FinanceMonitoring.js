...
export default function FinanceMonitoring() {
  ...
  const seriesSeven = [
    {
      data: [
        10, 12, 18, 25, 15, 30, 40, 10, 20, 12, 16, 60, 20, 15, 10, 60, 50, 40,
        80, 100, 30, 40, 10, 20, 12, 16, 60, 20, 15, 60, 20, 15, 10, 60, 50, 40,
        30, 40, 10, 20, 16, 60, 20, 15, 60, 20, 15, 10, 60, 50, 40, 30, 40, 10,
        20,
      ],
    },
    {
      data: [
        -10, -12, -18, -25, -15, -30, -40, -10, -20, -12, -16, -60, -20, -15,
        -10, -60, -50, -40, -80, -40, -30, -40, -10, -20, -12, -16, -60, -20,
        -15, -60, -20, -15, -10, -60, -50, -40, -30, -40, -10, -20, -40, -10,
        -20, -12, -16, -60, -20, -15, -60, -20, -15, -10, -60, -50, -40,
      ],
    },
  ];
              ...
              <Card.Body className="overflow-hidden px-0 pb-3">
                <div className="finance-info p-3 p-xl-4">
                  ...
                  <h1 className="finance-value">
                    <span>$</span>867,036.50 <span>USD</span>
                  </h1>
          ...
          <Col sm="6" xl>
            <Card className="card-one">
              <Card.Body>
                ...
                <label className="fw-semibold text-dark mb-1">
                  Quick Ratio Goal: 1.0 or higher
                </label>
                <p className="fs-sm text-secondary mb-0">
                  Measures your Accounts Receivable / Current Liabilities
                </p>
              </Card.Body>
            </Card>
          </Col>
            ...
            <Card className="card-one">
              ...
              <Card.Body className="pt-0">
                <p className="fs-sm text-secondary mb-4">
                  Profit margin is a measure of profitability. It is calculated
                  by finding the profit as a percentage of the revenue.
                </p>
                  ...
                  <Col sm="6" xl="3">
                    <div className="d-flex">
                      ...
                      <div>
                        ...
                        <p className="fs-sm text-secondary mb-0">
                          The proceeds or payment which the company will receive
                          from its customers.
                        </p>
                      </div>
                    </div>
