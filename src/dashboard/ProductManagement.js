            ...
            <Card className="card-one">
              ...
              <Card.Body className="p-3">
                <div className="position-absolute">
                  <h2 className="card-value mb-1 ls--1">
                    <span>$</span>8,358
                  </h2>
                  <small>
              ...
              <Card.Body className="px-0 pb-3">
                <div className="total-sales-body">
                  ...
                  <p className="w-50 fs-xs text-secondary mt-2 mb-0 d-none d-lg-block">
                    Note: Sed ut perspi ciatis unde omnis iste natus error sit
                    volup tatem accu santium dolor emque laudan...
                  </p>
                </div>
                <ReactApexChart
                  series={seriesFive}
          ...
          <Col sm="6" md>
            <Card className="card-one">
              <Card.Body className="p-3">
                ...
                <div className="d-grid">
                  <Button as="a" variant="secondary" className="btn-sm">
                    Sold Out
                  </Button>
                </div>
              </Card.Body>
              ...
              <Card.Body className="p-3">
                <Row className="g-3">
                  <Col sm="4" md="3" xl="4">
                    ...
                    <p className="fs-xs text-secondary mb-1">
                      Dec 20, 2023 8:45am
                    </p>
