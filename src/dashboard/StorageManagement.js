        ...
        <Row className="g-3">
          <Col xs="12" sm="6" xl>
            <Card className="card-one">
              <Card.Body className="p-3">
                <div className="mb-1 text-primary ti--3">
                  <i className="ri-rocket-line fs-48 lh-1"></i>
                </div>
                <h6 className="fw-semibold text-dark mb-1">Applications</h6>
                <p className="fs-xs text-secondary">
                  <span className="ff-numerals">6,320</span> Files
                </p>
          ...
          <Col xs="6" sm="6" xl>
            <Card className="card-one">
              <Card.Body className="p-3">
                <div className="mb-1 text-primary ti--3">
                  <i className="ri-file-text-line fs-48 lh-1"></i>
                </div>
                <h6 className="fw-semibold text-dark mb-1">Documents</h6>
                <p className="fs-xs text-secondary">
                  <span className="ff-numerals">4,067</span> Files
                </p>
          ...
          <Col xs="6" sm="6" xl>
            <Card className="card-one">
              <Card.Body className="p-3">
                <div className="mb-1 text-primary ti--3">
                  <i className="ri-gallery-line fs-48 lh-1"></i>
                </div>
                <h6 className="fw-semibold text-dark mb-1">Media</h6>
                <p className="fs-xs text-secondary">
                  <span className="ff-numerals">1,983</span> Files
                </p>
          ...
          <Col xs="6" sm="6" xl>
            <Card className="card-one">
              <Card.Body className="p-3">
                <div className="mb-1 text-primary ti--3">
                  <i className="ri-folder-zip-line fs-48 lh-1"></i>
                </div>
                <h6 className="fw-semibold text-dark mb-1">Archives</h6>
                <p className="fs-xs text-secondary">
                  <span className="ff-numerals">3,508</span> Files
                </p>
          ...
          <Col xs="6" sm="6" xl>
            <Card className="card-one">
              <Card.Body className="p-3">
                <div className="mb-1 text-primary ti--3">
                  <i className="ri-folder-2-line fs-48 lh-1"></i>
                </div>
                <h6 className="fw-semibold text-dark mb-1">Others</h6>
                <p className="fs-xs text-secondary">
                  <span className="ff-numerals">845</span> Files
                </p>
              ...
              <Card.Body className="p-3">
                <Row className="g-3">
                  <Col sm="4" md="3">
                    <Row className="g-3">
                      <Col xs="4" sm="12">
                        <h2 className="card-value ls--1 mb-1">
                          69.8<span className="opacity-75">TB</span>
                        </h2>
                        <label className="card-label fw-medium text-secondary fs-sm fs-sm-normal">
                          Total Storage
                        </label>
                      </Col>
                      <Col xs="4" sm="12">
                        <h2 className="card-value ls--1 mb-1">
                          836.5<span className="opacity-75">K</span>
                        </h2>
                        <label className="card-label fw-medium text-secondary fs-sm fs-sm-normal">
                          Object Count
                        </label>
                      ...
                      <Col xs="4" sm="12">
                        <h2 className="card-value ls--1 mb-1">
                          88.1<span className="opacity-75">MB</span>
                        </h2>
                        <label className="card-label fw-medium text-secondary fs-sm fs-sm-normal">
                          Avg. Object Size
                        </label>
          ...
          <Col md="6" xl="4">
            <Card className="card-one card-daily-trends">
              <Card.Body className="p-3">
                <h6 className="card-title fw-semibold text-dark fs-15 mb-1">
                  Daily Trends
                </h6>
                <p className="text-secondary">
                  CPU Power - <span className="ff-numerals">11/20/2023</span>
                </p>
              ...
              <Card.Body className="p-4">
                ...
                <Row className="g-3">
                  <Col xs="6">
                    ...
                    <h2 className="card-value ls--1 mb-0">
                      286.3<span>GB</span>
                    </h2>
                  </Col>
                  <Col xs="6">
            ...
            <Card className="card-one card-article">
              <Card.Body>
                ...
                <h4 className="card-title mb-3">
                  Overhaul Cloud-based Storage Analytics and Monitoring Suite
                </h4>
                <p className="text-secondary mb-4">
                  Nam libero tempore, cum soluta nobis est eligendi optio cumque
                  nihil impedit quo minus id quod maxime placeat facere
                  possimus, omnis voluptas assumenda est similique sunt in culpa
