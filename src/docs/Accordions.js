...
export default function Accordions() {
      ...
      <div className="main main-docs">
        <Container>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Accordion defaultActiveKey="0">
  <Accordion.Item eventKey="0">
    <Accordion.Header>Accordion Item #1</Accordion.Header>
    <Accordion.Body>
  ...
  <Accordion.Item eventKey="2">...</Accordion.Item>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Accordion defaultActiveKey="0" flush>
  ...
  <Accordion.Item eventKey="2">...</Accordion.Item>
          ...
          <p>
            Add <code>alwaysOpen</code> to make accordion items stay open when
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Accordion defaultActiveKey="0" alwaysOpen>
  <Accordion.Item eventKey="0">...</Accordion.Item>
  <Accordion.Item eventKey="1">...</Accordion.Item>
  <Accordion.Item eventKey="2">...</Accordion.Item>
</Accordion>`}</code>
          ...
          <p>
            We've created a custom style to the active state panel based on the
            brand color for this template.
          </p>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Accordion defaultActiveKey="0" className="accordion-custom">
  <Accordion.Item eventKey="0">...</Accordion.Item>
  <Accordion.Item eventKey="1">...</Accordion.Item>
  <Accordion.Item eventKey="2">...</Accordion.Item>
</Accordion>`}</code>
          ...
          <p>
            We've created a colored variant style based on the primary brand
            color.
          </p>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Accordion defaultActiveKey="0" className="accordion-primary">
  <Accordion.Item eventKey="0">...</Accordion.Item>
  <Accordion.Item eventKey="1">...</Accordion.Item>
  <Accordion.Item eventKey="2">...</Accordion.Item>
</Accordion>`}</code>
