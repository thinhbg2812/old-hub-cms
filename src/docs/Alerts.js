    ...
    <React.Fragment>
      ...
      <div className="main main-docs">
        <Container>
          ...
          <p>
            The accordion uses collapse internally to make it collapsible. Click
            the accordions below to expand/collapse the accordion content.
          </p>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Alert variant={variant}>
  This is a {variant} alert—check it out!
</Alert>`}</code>
              </pre>
            </Card.Footer>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Alert variant="primary">
...
<Alert variant="success">
  A simple success alert with <Alert.Link href="#">an example link</Alert.Link>. Give it a click if you like.
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Alert variant="success">
  ...
  <p className="mb-0">
    ...
    nice and tidy.
          ...
          <p>
            ...
            alert inline. Add attribute <code>dismissible</code>, which adds
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Alert variant="warning" dismissible>
  <strong>Holy guacamole!</strong> You should check in on some of those fields below.
          ...
          <p>
            An outline style variant with a little thicker border and a little
            thicker font weight with both border and text have the same color.
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Alert variant={variant} className="alert-outline">
  This is a {variant} alert—check it out!
</Alert>`}</code>
              </pre>
            </Card.Footer>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Alert variant={variant} className="alert-solid">
  This is a {variant} alert—check it out!
</Alert>`}</code>
              </pre>
            </Card.Footer>
          ...
          <Card className="card-example">
            <Card.Body>
              ...
              >
                <i className="ri-information-line"></i> A primary alert—check it
                out!
              </Alert>
              <Alert
                variant="primary"
                className="alert-outline d-flex align-items-center mb-2"
              >
                <i className="ri-information-line"></i> A primary alert—check it
                out!
              </Alert>
              <Alert
                variant="primary"
                className="alert-solid d-flex align-items-center mb-0"
              >
                <i className="ri-information-line"></i> A primary alert—check it
                out!
              </Alert>
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Alert variant="primary" className="d-flex align-items-center mb-2">
