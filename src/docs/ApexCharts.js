      ...
      <div className="main main-docs">
        <Container>
          ...
          <p className="main-title-text">
            ApexCharts is a modern charting library that helps developers to
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<ReactApexChart series={seriesBar} options={optionBar} type="bar" height={350} />`}</code>
              </pre>
            </Card.Footer>
          </Card>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<ReactApexChart series={seriesColumn} options={optionColumn} type="bar" height={350} />`}</code>
              </pre>
            </Card.Footer>
          </Card>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<ReactApexChart series={seriesStacked} options={optionStacked} type="bar" height={350} />`}</code>
              </pre>
            </Card.Footer>
          </Card>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<ReactApexChart series={seriesLine} options={optionLine} type="line" height={350} />`}</code>
              </pre>
            </Card.Footer>
          </Card>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<ReactApexChart series={seriesArea} options={optionArea} type="area" height={350} />`}</code>
              </pre>
            </Card.Footer>
          </Card>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<ReactApexChart series={seriesRadius} options={optionRadius} type="bar" height={350} />`}</code>
              </pre>
            </Card.Footer>
          </Card>
          ...
          <p>
            Below is the bar chart example with gradient effect of the chart.
          </p>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<ReactApexChart series={seriesGradient} options={optionGradient} type="area" height={350} />`}</code>
              </pre>
            </Card.Footer>
          </Card>
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">
                  {
                    '<ReactApexChart series={seriesPie} options={optionPie} type="pie" width={380} />'
                  }
                </code>
              </pre>
            </Card.Footer>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">
                  {
                    '<ReactApexChart series={seriesDonut} options={optionDonut} type="donut" width={380} />'
                  }
                </code>
              </pre>
            </Card.Footer>
