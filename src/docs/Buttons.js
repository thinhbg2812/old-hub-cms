      ...
      <div className="main main-docs">
        <Container>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Button variant="primary">Primary</Button>
<Button variant="secondary">Secondary</Button>
<Button variant="success">Success</Button>
<Button variant="warning">Warning</Button>
<Button variant="danger">Danger</Button>
...
<Button variant="dark">Dark</Button>`}</code>
          ...
          <p>
            ...
            Replace the variant attribute with the <code>outline-*</code> ones
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Button variant="outline-primary">Primary</Button>
<Button variant="outline-secondary">Secondary</Button>
<Button variant="outline-success">Success</Button>
<Button variant="outline-warning">Warning</Button>
<Button variant="outline-danger">Danger</Button>
...
<Button variant="outline-dark">Dark</Button>`}</code>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Button variant="primary" size="sm">Small button</Button>
<Button variant="primary" size="lg">Large button</Button>`}</code>
              </pre>
            </Card.Footer>
          </Card>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<div className="d-grid gap-2">
  <Button variant="primary">Small button</Button>
  <Button variant="secondary">Large button</Button>
</div>`}</code>
              </pre>
          ...
          <p>
            ...
            border, and inset shadow) when active and also by adding active
            class.
          </p>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Button variant="primary">Button</Button>
<Button variant="primary" active>Active Button</Button>`}</code>
              </pre>
            </Card.Footer>
          </Card>
          ...
          <p>
            Make buttons look inactive by adding the disabled boolean attribute
            to any button element.
          </p>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Button variant="primary">Button</Button>
<Button variant="primary" disabled>Disabled Button</Button>`}</code>
              </pre>
            </Card.Footer>
          </Card>
          ...
          <p>
            Make rounded corner buttons by adding a class modifier from
            Bootstrap utilities class <code>.rounded-pill</code>
          </p>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Button variant="primary" className="rounded-pill">Primary Button</Button>
<Button variant="success" className="rounded-pill">Success Button</Button>`}</code>
              </pre>
            </Card.Footer>
          </Card>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Button variant="primary" className="btn-icon"><i className="ri-menu-line"></i></Button>
<Button variant="secondary" className="btn-icon"><i className="ri-pencil-fill"></i></Button>`}</code>
              </pre>
            </Card.Footer>
          </Card>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<ButtonGroup aria-label="Basic example">
  <Button variant="primary">Left</Button>
  <Button variant="primary">Middle</Button>
  <Button variant="primary">Right</Button>
</ButtonGroup>`}</code>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<ButtonGroup aria-label="Basic checkbox toggle button group">
  ...
  <label className="btn btn-outline-primary" htmlFor="btncheck3">Checkbox 3</label>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<div className="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
  <ButtonGroup className="me-2" aria-label="First group">
