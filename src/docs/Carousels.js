      ...
      <div className="main main-docs">
        <Container>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Carousel>
  <Carousel.Item>
    <img
      className="d-block w-100"
      src={img2}
      ...
      <p>
        Praesent commodo cursus magna, vel scelerisque nisl consectetur.
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Carousel fade></Carousel`}</code>
              </pre>
            </Card.Footer>
          </Card>
          ...
          <p>
            Set the slide prop to false to disable the transition animation
            between slides.
          </p>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Carousel slide={false}></Carousel`}</code>
              </pre>
            </Card.Footer>
          </Card>
