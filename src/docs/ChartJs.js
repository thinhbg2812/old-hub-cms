      ...
      <div className="main main-docs">
        <Container>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Bar data={dataBar} options={optionBar} className="ht-300" />`}</code>
              </pre>
            </Card.Footer>
          </Card>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Bar data={dataBar2} options={optionBar2} className="ht-350" />`}</code>
              </pre>
            </Card.Footer>
          </Card>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Bar data={dataBar3} options={optionBar3} className="ht-300" />`}</code>
              </pre>
            </Card.Footer>
          </Card>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Line data={dataLine} options={optionLine} className="ht-300" />`}</code>
              </pre>
            </Card.Footer>
          </Card>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Line data={dataLine2} options={optionLine2} className="ht-300" />`}</code>
              </pre>
            </Card.Footer>
          </Card>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Bar data={dataBar4} options={optionBar4} className="ht-300" />`}</code>
              </pre>
            </Card.Footer>
          </Card>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Pie data={dataPie} options={optionPie} className="ht-200" />
<Doughnut data={dataPie} options={optionPie} className="ht-200" />`}</code>
              </pre>
            </Card.Footer>
          </Card>
