      ...
      <div className="main main-docs">
        <Container>
          ...
          <p className="main-title-text">
            Give textual form controls like inputs and textareas an upgrade with
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<div className="mb-3">
...
<div>
  ...
  <Form.Control as="textarea" id="exampleFormControlTextarea1" rows="3" placeholder="Enter message here..."></Form.Control>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Form.Control className="form-control-lg mb-2" type="text" placeholder="Large input" />
<Form.Control className="mb-2" type="text" placeholder="Default input" />
<Form.Control className="form-control-sm" type="text" placeholder="Small input" />`}</code>
              </pre>
            </Card.Footer>
          </Card>
          ...
          <p>
            Add the disabled boolean attribute on an input to give it a grayed
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Form.Control className="mb-2" type="text" placeholder="Disabled input" disabled />
<Form.Control type="text" value="Disabled readonly input" disabled readOnly />`}</code>
              </pre>
            </Card.Footer>
          </Card>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Form.Control type="text" value="Readonly input" readOnly />`}</code>
              </pre>
            </Card.Footer>
          </Card>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Form.Group controlId="formFile" className="mb-3">
  <Form.Label>Default file input example</Form.Label>
  <Form.Control type="file" />
</Form.Group>
<Form.Group controlId="formFileMultiple" className="mb-3">
