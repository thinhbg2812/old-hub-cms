      ...
      <div className="main main-docs">
        <Container>
          ...
          <p className="main-title-text">
            Give your forms some structure—from inline to horizontal to custom
            grid implementations—with our form layout options.
          </p>
...
<div>
  ...
  <Col>
    <Form.Control type="text" placeholder="Last name" aria-label="Last name" />
          ...
          <p>
            By adding gutter modifier classes, you can have control over the
  ...
  <Col>
    <Form.Control type="text" placeholder="Last name" aria-label="Last name" />
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Form>
  <Row className="mb-3">
  ...
  <Button type="submit" variant="primary">Sign in</Button>
          ...
          <p>
            ...
            place any number of <code>Col</code> within a <code>Row</code>.
