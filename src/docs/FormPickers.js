      ...
      <div className="main main-docs">
        <Container>
          ...
          <p className="main-title-text">
            The date and color picker is tied to a standard form input field.
            Focus on the input (click, or use the tab key) to open an
            interactive calendar in a small overlay.
          </p>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-js">{`<ReactDatePicker selected={startDate} onChange={(date) => setStartDate(date)} inline />`}</code>
              </pre>
            </Card.Footer>
          </Card>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-js">{`<ReactDatePicker selected={startDate2} onChange={(date) => setStartDate2(date)} className="form-control" />`}</code>
              </pre>
            </Card.Footer>
          </Card>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-js">{`<ReactDatePicker
  renderCustomHeader={({
    monthDate,
    customHeaderCount,
    decreaseMonth,
...
/>`}</code>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-js">{`<SketchPicker />`}</code>
              </pre>
            </Card.Footer>
          </Card>
