      ...
      <div className="main main-docs">
        <Container>
          ...
          <p className="main-title-text">
            Use our custom range inputs for consistent cross-browser styling and
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Form.Range />`}</code>
              </pre>
            </Card.Footer>
          </Card>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Form.Range disabled />`}</code>
              </pre>
            </Card.Footer>
          </Card>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Form.Range min={0} max={5} />`}</code>
              </pre>
            </Card.Footer>
          </Card>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Form.Range min={0} max={5} step={0.5} />`}</code>
              </pre>
            </Card.Footer>
          </Card>
