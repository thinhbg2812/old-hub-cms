    ...
    <React.Fragment>
      ...
      <div className="main main-docs">
        <Container>
          ...
          <p>
            Images in React Bootstrap are made responsive using fluid set to
            true with max-width: 100%; and height: auto; are applied to the
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Image src={img3} fluid={true} alt="..." />`}</code>
              </pre>
            </Card.Footer>
          </Card>
          ...
          <p>
            ...
            props to give an image a rounded 1px border appearance.
          </p>
          ...
          <Card className="card-example">
            <Card.Body>
              <Image
                ...
                fluid={true}
                alt="..."
                className="float-start w-200"
              />
              <Image
                src={img4}
                fluid={true}
                alt="..."
                className="float-end w-200"
              />
            </Card.Body>
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Image src={img3} fluid={true} alt="..." className="float-start w-200" />
<Image src={img4} fluid={true} alt="..." className="float-end w-200" />`}</code>
              </pre>
            </Card.Footer>
          </Card>
          ...
          <Card className="card-example">
                  ...
                  <figure className="figure-overlay">
                    ...
                    <figcaption className="p-4 text-white">
                      ...
                      <p className="mb-0">
                        ...
                        use the item once per end product. You don't need to pay
                        additional or ongoing fees for each person who sees or
                        uses it.
                      </p>
                    </figcaption>
                  </figure>
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<figure className="figure-overlay">
  <Image src={img3} fluid={true} alt="..." />
  <figcaption className="p-4 text-white">
    <h6 className="mb-3">What Does Royalty-Free Mean?</h6>
