...
export default function LayoutColumns() {
      ...
      <div className="main main-docs">
        <Container>
          ...
          <p className="main-title-text">
            Learn how to modify columns with a handful of options for alignment,
            ordering, and offsetting thanks to our flexbox grid system.
          </p>
          ...
          <Card className="card-example">
            <Card.Body>
              <Row className="g-2 row-example ht-150 align-items-center">
                <Col>
                  <span>1 of 3 Column</span>
                </Col>
                <Col>
                  <span>2 of 3 Column</span>
                </Col>
                <Col>
                  <span>3 of 3 Column</span>
                </Col>
              </Row>
            </Card.Body>
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Row className="ht-150 align-items-center">
  ...
  <Col><span>3 of 3 Column</span></Col>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Row className="ht-150 align-items-end">
  <Col><span>1 of 3 Column</span></Col>
  <Col><span>2 of 3 Column</span></Col>
  <Col><span>3 of 3 Column</span></Col>
</Row>`}</code>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Row className="ht-150">
  ...
  <Col className="align-self-end"><span>3 of 3 Column</span></Col>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Row className="justify-content-center">
  ...
  <Col xs="3"><span>3 of 3 Column</span></Col>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Row className="justify-content-end">
  <Col xs="3"><span>1 of 3 Column</span></Col>
  <Col xs="3"><span>2 of 3 Column</span></Col>
  <Col xs="3"><span>3 of 3 Column</span></Col>
</Row>`}</code>
          ...
          <Card className="card-example">
            <Card.Body>
              <Row className="g-2 row-example justify-content-between">
                <Col xs="3">
                  <span>1 of 2 Column</span>
                </Col>
                <Col xs="3">
                  <span>2 of 2 Column</span>
                </Col>
              </Row>
            </Card.Body>
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Row className="justify-content-between">
  ...
  <Col xs="3"><span>2 of 2 Column</span></Col>
          ...
          <p>
            ...
            an element with width: 100% wherever you want to wrap your columns
            to a new line.
          </p>
          ...
          <Card className="card-example">
            <Card.Body>
              <Row className="g-2 row-example">
                <Col xs="4">
                  <span>1 of 4 Column</span>
                </Col>
                <Col xs="4">
                  <span>2 of 4 Column</span>
                </Col>

                <div className="w-100"></div>

                <Col xs="4">
                  <span>3 of 4 Column</span>
                </Col>
                <Col xs="4">
                  <span>4 of 4 Column</span>
                </Col>
              </Row>
            </Card.Body>
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Row>
  ...
  <Col xs="4"><span>4 of 4 Column</span></Col>
          ...
          <p>
            Use .order- classes for controlling the visual order of your
            content. These classes are responsive, so you can set the order by
            breakpoint.
          </p>
  ...
  <Col xs="4" className="order-1"><span>3 of 3 Column</span></Col>
          ...
          <p>
            ...
            match columns while margins are more useful for quick layouts where
  ...
  <Col xs="4" className="offset-3"><span>2 of 2 Column</span></Col>
          ...
          <p>
            ...
            .me-auto to force sibling columns away from one another.
          </p>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Row className="g-2 row-example">
  <Col xs="4"><span>1 of 2 Column</span></Col>
  <Col xs="4" className="ms-auto"><span>2 of 2 Column</span></Col>
          ...
          <p>
            The .col-* classes can also be used outside a .row to give an
            element a specific width. Whenever column classes are used as non
            direct children of a row, the paddings are omitted.
          </p>
