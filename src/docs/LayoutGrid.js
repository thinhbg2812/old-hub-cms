...
export default function LayoutGrid() {
      ...
      <div className="main main-docs">
        <Container>
          ...
          <p className="main-title-text">
            Use Bootstrap's powerful mobile-first flexbox grid to build layouts
  ...
  <Col><span>3 of 3 Column</span></Col>
          ...
          <p>
            Using a single set of classes, you can create a basic grid system
  ...
  <Col sm="5"><span>2 of 2 Column</span></Col>
          ...
          <p>
            ...
            or to control your card layouts.
          </p>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Row xs="2">
