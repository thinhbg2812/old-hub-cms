...
export default function LayoutGutters() {
      ...
      <div className="main main-docs">
        <Container>
          ...
          <p>
            ...
            classes to modify horizontal gutters, vertical gutters, and all
            gutters.
          </p>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Row className="gx-5">
  ...
  <Col><span>3 of 3 Column</span></Col>
          ...
          <p>
            Like the horizontal gutters, the vertical gutters can cause some
            overflow below the row at the end of a page.
          </p>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Row className="gy-5">
  ...
  <Col xs="6"><span>4 of 4 Column</span></Col>
          ...
          <p>
            Classes <code>.g-*</code> can be used to control the horizontal
            gutter widths, for the following example we use a smaller gutter
            width, so there won’t be a need to add the .overflow-hidden wrapper
            class.
          </p>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Row className="g-2">
  <Col xs="6"><span>1 of 4 Column</span></Col>
  <Col xs="6"><span>2 of 4 Column</span></Col>
  <Col xs="6"><span>3 of 4 Column</span></Col>
  <Col xs="6"><span>4 of 4 Column</span></Col>
          ...
          <p>
            ...
            removed with <code>.g-0</code>. This removes the negative margins
            from .row and the horizontal padding from all immediate children
            columns.
          </p>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Row className="g-0">
  <Col xs="6"><span>1 of 4 Column</span></Col>
  <Col xs="6"><span>2 of 4 Column</span></Col>
  <Col xs="6"><span>3 of 4 Column</span></Col>
  <Col xs="6"><span>4 of 4 Column</span></Col>
