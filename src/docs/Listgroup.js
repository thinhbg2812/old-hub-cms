...
export default function Listgroup() {
      ...
      <div className="main main-docs">
        <Container>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<ListGroup>
  <ListGroup.Item>Cras justo odio</ListGroup.Item>
  <ListGroup.Item>Dapibus ac facilisis in</ListGroup.Item>
  <ListGroup.Item>Morbi leo risus</ListGroup.Item>
  <ListGroup.Item>Porta ac consectetur ac</ListGroup.Item>
  <ListGroup.Item>Vestibulum at eros</ListGroup.Item>
          ...
          <p>
            Add active props to a <code>ListGroup.Item</code> to indicate the
  ...
  <ListGroup.Item>Vestibulum at eros</ListGroup.Item>
          ...
          <p>
            Add disabled props to a <code>ListGroup.Item</code> to indicate the
            current active selection.
          </p>
  ...
  <ListGroup.Item>Vestibulum at eros</ListGroup.Item>
          ...
          <p>
            Add action props to create actionable list group items with hover,
            disabled, and active states in <code>ListGroup.Item</code>.
          </p>
  ...
  <ListGroup.Item action href="#">Vestibulum at eros</ListGroup.Item>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<ListGroup as="ol" numbered>
  <ListGroup.Item as="li">Cras justo odio</ListGroup.Item>
  <ListGroup.Item as="li">Dapibus ac facilisis in</ListGroup.Item>
  <ListGroup.Item as="li">Morbi leo risus</ListGroup.Item>
  <ListGroup.Item as="li">Porta ac consectetur ac</ListGroup.Item>
  <ListGroup.Item as="li">Vestibulum at eros</ListGroup.Item>
          ...
          <p>
            ...
            and more with the help of some utilities.
          </p>
