...
export default function MapLeaflet() {
      ...
      <div className="main main-docs">
        <Container>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<MapContainer center={[51.505, -0.09]} zoom={7} scrollWheelZoom={false}>
  <TileLayer
    attribution="&copy; OpenStreetMap"
    url="https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png"
    maxZoom={19}
  />
          ...
          <p>
            Popups are usually used when you want to attach some information to
            a particular object on a map.
          </p>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<div className="leaflet-wrapper">
      ...
      <Popup>
        A pretty CSS3 popup. <br /> Easily customizable.
          ...
          <p>
            ...
            including polylines, polygons, circles, and popups.
          </p>
