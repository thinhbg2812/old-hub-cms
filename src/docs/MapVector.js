      ...
      <div className="main main-docs">
        <Container>
          ...
          <p className="main-title-text">
            A vector-based, cross-browser and cross-platform component for
            interactive geography-related data visualization on the web.
          </p>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<VectorMap map={worldMill} backgroundColor="#fff" regionStyle={regStyle} />`}</code>
              </pre>
            </Card.Footer>
          </Card>
          ...
          <p>
            Whether to show tooltips on mouseover (true or false, defaults to
            true).
          </p>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<VectorMap map={usAea} backgroundColor="#fff" regionStyle={regStyle} />`}</code>
              </pre>
            </Card.Footer>
          </Card>
          ...
          <p>
            In this example, we are showing pre selected region in country of
            United States.
          </p>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<div className="ht-350">
