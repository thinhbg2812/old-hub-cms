      ...
      <div className="main main-docs">
        <Container>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Offcanvas show={show} onHide={handleClose}>
  <Offcanvas.Header closeButton>
    <Offcanvas.Title>Offcanvas</Offcanvas.Title>
  </Offcanvas.Header>
  <Offcanvas.Body>
    ...
    have chosen. Like, text, images, lists, etc.
          ...
          <Card className="card-example">
            <Card.Body>
              <Button variant="primary" onClick={handleShowTop}>
                Offcanvas Top
              </Button>
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Offcanvas show={showTop} onHide={handleCloseTop} placement="top">...</Offcanvas>`}</code>
              </pre>
            </Card.Footer>
          </Card>
          ...
          <Card className="card-example">
            <Card.Body>
              <Button variant="primary" onClick={handleShowBottom}>
                Offcanvas Bottom
              </Button>
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Offcanvas show={showBottom} onHide={handleCloseBottom} placement="bottom">...</Offcanvas>`}</code>
              </pre>
            </Card.Footer>
          </Card>
          ...
          <Card className="card-example">
            <Card.Body>
              <Button variant="primary" onClick={handleShowRight}>
                Offcanvas Right
              </Button>
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Offcanvas show={showRight} onHide={handleCloseRight} placement="end">...</Offcanvas>`}</code>
              </pre>
            </Card.Footer>
          </Card>
          ...
          <p>
            ...
            backdrop are visible. Use the scroll prop to toggle body scrolling
            and the backdrop prop to toggle the backdrop.
          </p>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Offcanvas show={show2} onHide={handleClose2} backdrop={false}>...</Offcanvas>`}</code>
              </pre>
            </Card.Footer>
          </Card>
