...
export default function Paginations() {
      ...
      <div className="main main-docs">
        <Container>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Pagination className="mb-0">
  <Pagination.Item disabled>Previous</Pagination.Item>
  <Pagination.Item active>1</Pagination.Item>
  <Pagination.Item>2</Pagination.Item>
  <Pagination.Item>3</Pagination.Item>
  <Pagination.Item>Next</Pagination.Item>
          ...
          <p>
            Horizontal alignment of pagination can be done by adding flex
            utility classes.
          </p>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Pagination className="justify-content-center mb-0">...</Pagination>`}</code>
              </pre>
            </Card.Footer>
          </Card>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Pagination className="justify-content-end mb-0">...</Pagination>`}</code>
              </pre>
            </Card.Footer>
          </Card>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Pagination className="pagination-space mb-0">...</Pagination>`}</code>
              </pre>
            </Card.Footer>
          </Card>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Pagination className="pagination-space pagination-secondary">...</Pagination>
<Pagination className="pagination-space pagination-info">...</Pagination>`}</code>
              </pre>
            </Card.Footer>
          </Card>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Pagination className="pagination-space pagination-filled mb-0">...</Pagination>`}</code>
              </pre>
            </Card.Footer>
          </Card>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Pagination className="pagination-space pagination-circled mb-0">...</Pagination>`}</code>
              </pre>
            </Card.Footer>
          </Card>
