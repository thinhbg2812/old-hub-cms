      ...
      <div className="main main-docs">
        <Container>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<ProgressBar className="mb-2" />
<ProgressBar now={25} className="mb-2" />
<ProgressBar now={50} className="mb-2" />
<ProgressBar now={75} className="mb-2" />
<ProgressBar now={100} />`}</code>
              </pre>
            </Card.Footer>
          </Card>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<ProgressBar now="50" label="50%" />`}</code>
              </pre>
            </Card.Footer>
          </Card>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<ProgressBar now="50" className="h-1 mb-2" />
<ProgressBar now="50" className="h-2" />`}</code>
              </pre>
            </Card.Footer>
          </Card>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<ProgressBar variant="success" now={40} className="mb-2" />
<ProgressBar variant="info" now={20} className="mb-2" />
<ProgressBar variant="warning" now={60} className="mb-2" />
<ProgressBar variant="danger" now={80} />`}</code>
              </pre>
            </Card.Footer>
          </Card>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<ProgressBar>
  <ProgressBar now={25} />
  <ProgressBar variant="success" now={25} />
  <ProgressBar variant="info" now={25} />
</ProgressBar>`}</code>
          ...
          <p>
            Add <code>.progress-bar-striped</code> to any progress bar to apply
            a stripe via CSS gradient over the progress bar’s background color.
          </p>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<ProgressBar striped variant="success" now={40} className="mb-2" />
<ProgressBar striped variant="info" now={20} className="mb-2" />
<ProgressBar striped variant="warning" now={60} className="mb-2" />
<ProgressBar striped variant="danger" now={80} />`}</code>
              </pre>
            </Card.Footer>
          </Card>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<ProgressBar animated now={75} />`}</code>
              </pre>
            </Card.Footer>
          </Card>
