...
export default function Tables() {
      ...
      <div className="main main-docs">
        <Container>
          ...
          <p>
            ...
            look in Bootstrap. All table styles are inherited in Bootstrap 5,
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Table className="mb-0">
  <thead>
    <tr>
      <th scope="col">ID</th>
      <th scope="col">Name</th>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>$250,000</td>
          ...
          <p>
            Use <code>striped</code> props to add zebra-striping to any table
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Table striped className="mb-0">...</Table`}</code>
              </pre>
            </Card.Footer>
          </Card>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<tr className="table-active">
  <th scope="row">2</th>
  <td>Socrates Itumay</td>
  <td>Software Engineer</td>
  <td>Computer Engineering</td>
  <td>$150,000</td>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Table variant="primary">...</Table>
<Table variant="success">...</Table>`}</code>
              </pre>
            </Card.Footer>
          </Card>
          ...
          <p>
            Add <code>bordered</code> props for borders on all sides of the
            table and cells. Add <code>borderless</code> props for a table
            without borders.
          </p>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Table bordered className="mb-0">...</Table>`}</code>
              </pre>
            </Card.Footer>
          </Card>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Table borderless className="mb-0">...</Table>`}</code>
              </pre>
            </Card.Footer>
          </Card>
          ...
          <p>
            Add <code>size</code> props to make any table more compact by
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Table size="sm" className="mb-0">...</Table>`}</code>
              </pre>
            </Card.Footer>
          </Card>
          ...
          <p>
            ...
            table with props <code>responsive</code>.
          </p>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Table responsive className="mb-0">...</Table>`}</code>
              </pre>
            </Card.Footer>
          </Card>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-js">{`<Grid
  data={[
...
/>`}</code>
          ...
          <h5 id="section12" className="main-subtitle">
            Sorting
          </h5>
          <p>
...
/>`}</code>
          ...
          <p>
            Simply add <code>resizable: true</code> to your config to enable
            resizable columns.
          </p>
