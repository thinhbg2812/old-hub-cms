      ...
      <div className="main main-docs">
        <Container>
          ...
          <Card className="card-example">
            <Card.Body>
              <div className="demo-text">
                <p className="text-primary">
                  Seeing a spider in my room isn't scary. It's scary when it
                  disappears.
                </p>
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<p className="text-primary">Seeing a spider in my room isn't scary. It's scary when it disappears.</p>
...
<p className="text-dark">Seeing a spider in my room isn't scary. It's scary when it disappears.</p>`}</code>
              </pre>
            </Card.Footer>
          </Card>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<Link className="link-primary">Seeing a spider in my room isn't scary. It's scary when it disappears.</Link>
...
<Link className="link-dark">Seeing a spider in my room isn't scary. It's scary when it disappears.</Link>`}</code>
              </pre>
            </Card.Footer>
          </Card>
          ...
          <Card className="card-example">
            <Card.Body>
              <div className="demo-text">
                ...
                <p className="text-primary text-opacity-25">
                  Seeing a spider in my room isn't scary. It's scary when it
                  disappears.
                </p>
              </div>
...
<p className="text-primary text-opacity-25">Seeing a spider in my room isn't scary. It's scary when it disappears.</p>`}</code>
              </pre>
            </Card.Footer>
          </Card>
