...
export default function UtilDivider() {
    ...
    <React.Fragment>
      ...
      <div className="main main-docs">
        <Container>
          ...
          <p>
            The example divider below allows you to separate section with this
            basic divider element.
          </p>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<div className="divider"></div>`}</code>
              </pre>
            </Card.Footer>
          </Card>
          ...
          <p>
            The example divider below allows you to add text label with this
            basic divider element.
          </p>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<div className="divider"><span>Example Text</span></div>`}</code>
              </pre>
            </Card.Footer>
          </Card>
          ...
          <p>
            A divider variant with vertical display and with text in the center
  ...
  <div className="flex-fill ht-100 bg-gray-300"></div>
          ...
          <p>
            A divider variant with label alignment wheather in the center, left
            or right.
          </p>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<div className="divider divider-start"><span>Example Text</span></div>
<div className="divider divider-end"><span>Example Text</span></div>`}</code>
              </pre>
            </Card.Footer>
          </Card>
          ...
          <Card className="card-example">
            <Card.Body>
              <div className="d-flex mb-3">
                <div className="flex-fill ht-100 bg-gray-300"></div>
                <div className="divider divider-vertical divider-top">
                  <span>AND</span>
                </div>
                <div className="flex-fill ht-100 bg-gray-300"></div>
              </div>
              ...
              <div className="d-flex">
                <div className="flex-fill ht-100 bg-gray-300"></div>
                <div className="divider divider-vertical divider-bottom">
                  <span>AND</span>
                </div>
                <div className="flex-fill ht-100 bg-gray-300"></div>
              </div>
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<div className="d-flex mb-3">
  <div className="flex-fill ht-100 bg-gray-300"></div>
