      ...
      <div className="main main-docs">
        <Container>
          ...
          <p className="main-title-text">
            Use some extra class utilities to quickly style the element. Great
            for cards, text, buttons, or any other element.
          </p>
          ...
          <Card className="card-example">
            <Card.Footer>
              <pre>
                <code className="language-html">{`<div className="overflow-auto">...</div>
<div className="overflow-hidden">...</div>
<div className="overflow-visible">...</div>
<div className="overflow-scroll">...</div>`}</code>
              </pre>
            </Card.Footer>
          </Card>
          ...
          <Card className="card-example">
            <Card.Footer>
              <pre>
                <code className="language-html">{`<span className="align-baseline">baseline</span>
...
<span className="align-text-bottom">text-bottom</span>`}</code>
              </pre>
            </Card.Footer>
          </Card>
          ...
          <Card className="card-example">
            <Card.Footer>
              <pre>
                <code className="language-html">{`<div className="float-start">Float start on all viewport sizes</div><br>
<div className="float-end">Float end on all viewport sizes</div><br>
<div className="float-none">Don't float on all viewport sizes</div>`}</code>
              </pre>
            </Card.Footer>
          </Card>
          ...
          <Card className="card-example">
            <Card.Footer>
              <pre>
                <code className="language-html">{`<div className="visible">...</div>
<div className="invisible">...</div>`}</code>
              </pre>
            </Card.Footer>
          </Card>
