    ...
    <React.Fragment>
      ...
      <div className="main main-docs">
        <Container>
          ...
          <p>
            Assign responsive-friendly margin and padding values to an element
          ...
          <Table className="table-spacing">
            <tbody>
              ...
              <tr>
                ...
                <td>
                  for classes that set the <code>margin</code> to auto
                </td>
              </tr>
            </tbody>
          </Table>
          ...
          <p>
            Additionally, Bootstrap also includes an <code>.mx-auto</code> class
            for horizontally centering fixed-width block level content
          </p>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<div className="mx-auto w-200 p-2 bg-gray-200 text-center">
  Centered element
</div>`}</code>
              </pre>
            </Card.Footer>
          ...
          <p>
            When using <code>display: grid</code>, you can make use of gap
            utilities on the parent grid container. This can save on having to
            add margin utilities to individual grid items.
          </p>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<div className="d-grid gap-3">
  <div className="p-2 bg-light border">Grid item 1</div>
  <div className="p-2 bg-light border">Grid item 2</div>
  <div className="p-2 bg-light border">Grid item 3</div>
</div>`}</code>
