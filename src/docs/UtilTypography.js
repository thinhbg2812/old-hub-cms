      ...
      <div className="main main-docs">
        <Container>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<p className="text-start">Start aligned text on all viewport sizes.</p>
<p className="text-center">Center aligned text on all viewport sizes.</p>
<p className="text-end mb-0">End aligned text on all viewport sizes.</p>`}</code>
              </pre>
            </Card.Footer>
          </Card>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<p className="text-lowercase">Lowercased text.</p>
<p className="text-uppercase">Uppercased text.</p>
<p className="text-capitalize mb-0">CapiTaliZed text.</p>`}</code>
              </pre>
            </Card.Footer>
          </Card>
          ...
          <p>
            Quickly change the font size of text. Sizing for these utilities
            matches HTML's heading elements, so as the number increases, their
            size decreases.
          </p>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<p className="fs-1">No guts, no glory.</p>
<p className="fs-2">No guts, no glory.</p>
<p className="fs-3">No guts, no glory.</p>
<p className="fs-4">No guts, no glory.</p>
<p className="fs-5">No guts, no glory.</p>
<p className="fs-6 mb-0">No guts, no glory.</p>`}</code>
              </pre>
            </Card.Footer>
          </Card>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<p className="fw-bold">Bold text.</p>
...
<p className="fst-italic">Italic text.</p>
<p className="fst-normal mb-0">Text with normal font style</p>`}</code>
              </pre>
            </Card.Footer>
          </Card>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<p className="lh-1">...</p>
<p className="lh-sm">...</p>
<p className="lh-base">...</p>
<p className="lh-lg mb-0">...</p>`}</code>
              </pre>
            </Card.Footer>
          </Card>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<p className="font-monospace mb-0">This is in monospace</p>`}</code>
              </pre>
            </Card.Footer>
          </Card>
          ...
          <Card className="card-example">
            ...
            <Card.Footer>
              <pre>
                <code className="language-html">{`<p className="text-decoration-underline">This text has a line underneath it.</p>
<p className="text-decoration-line-through">This text has a line going through it.</p>
<a href="#" className="text-decoration-none">This link has its text decoration removed</a>`}</code>
              </pre>
            </Card.Footer>
          </Card>
