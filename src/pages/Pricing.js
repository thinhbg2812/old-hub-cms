  ...
  return (
    <React.Fragment>
      ...
      <div className="main main-pricing p-4 p-lg-5">
        <h1 className="pricing-title mb-2">
          Choose a price that's right for your project.
        </h1>
        ...
        <div className="d-flex gap-2">
          ...
          <Button variant="" className="btn-white fw-medium">
            Learn more
          </Button>
        </div>
        ...
        <Table className="table-pricing" responsive>
          ...
          <tbody>
            ...
            <tr>
              <td>
                <div className="d-flex align-items-center gap-2">
                  Duis aute irure dolor <i className="ri-information-line"></i>
                </div>
              </td>
              <td className="selected">&nbsp;</td>
              <td>&nbsp;</td>
            ...
            <tr>
              <td>
                <div className="d-flex align-items-center gap-2">
                  voluptatem sequi <i className="ri-information-line"></i>
                </div>
              </td>
              <td className="selected">&nbsp;</td>
              <td>&nbsp;</td>
            ...
            <tr>
              <td>
                <div className="d-flex align-items-center gap-2">
                  dignissimos <i className="ri-information-line"></i>
                </div>
              </td>
              <td className="selected">
                <i className="ri-check-fill"></i>
            ...
            <tr>
              <td>
                <div className="d-flex align-items-center gap-2">
                  maxime placeat facere <i className="ri-information-line"></i>
                </div>
              </td>
              <td className="selected">
                <i className="ri-check-fill"></i>
