...
const VehicleManagement = () => {
    ...
    const createVehicle = async() => {
        const resp = await createVehicleRequest(selectedVehicle.licensePlate, selectedVehicle.vehicleType, selectedVehicle.status, orgId)
        if(resp.isError){
                                    ...
                                    {vehicles.map((vehicle, index) =>  {
                                        return (
                                            <tr key={vehicle.id}>
                                                ...
                                                <td className="text-center">{vehicle.status ? "active" : "inactive"}</td>
                ...
                <ModalBody>
                    <Form noValidate onSubmit={handleSubmit} validated={validated}>
                        <Row className="mb-1">
                            ...
                            />
                            <FormControl.Feedback type="invalid">License number is required</FormControl.Feedback>
                            </FormGroup>
                        </Row>
                        <Row className="mb-1">
                            <Col>
                                <label for="type" className="form-label">Status:</label>
                                <select id="type" className="form-select"onChange={e => {
                                    const newItem = {
